  ...
  return (
        ...
        <div className="max-w-md w-full space-y-8">
          <div>
            ...
            <h2 className="mt-6 text-start text-2xl font-bold text-gray-900">Регистрация через SDU-почта</h2>
          ...
          <form className="mt-8 space-y-6" action="#" method="POST">
            ...
            <div className='mt-4'>
              ...
              <p className='text-center mt-2 text-gray-500'>Уже зарегистрированы?<a className='text-gray-900'> Войти</a></p>
            </div>
          </form>
        </div>
      </div>
