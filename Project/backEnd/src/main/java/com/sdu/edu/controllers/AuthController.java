...
import com.sdu.edu.pojo.JwtResponse;
import com.sdu.edu.pojo.LoginRequest;
import com.sdu.edu.pojo.MessageResponse;
import com.sdu.edu.pojo.SignupRequest;
...
//	public String activateUser(ActivateCodeDto activateCodeDto, Model model, HttpServletResponse response) {
//		String username = userService.activateUser(activateCodeDto);
//		if (!username.isBlank()) {
//			Authentication authentication = authenticationManager
//					.authenticate(new UsernamePasswordAuthenticationToken(
//							username, "12345678"));
...
//			return "redirect:/";
//		} else {
//			model.addAttribute("authError", "Неправильный логин или пароль.");
//			return "login";
//		}
//	}
}
